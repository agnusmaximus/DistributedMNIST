  ...
  def apply_gradients(self, grads_and_vars, global_step=None, name=None):
    ...
    with ops.name_scope(None, self._name):
      ...
      with ops.device(global_step.device), ops.name_scope(""):
        ...
        with ops.control_dependencies([tf.Print(self._local_step, [self._local_step], message="%d Dequeueing" % self._worker_id)]):
        ...
        with ops.control_dependencies([update_op]):
          ...
          with ops.control_dependencies([tf.Print(self._local_step, [self._local_step], message="Enqueueing")]):
