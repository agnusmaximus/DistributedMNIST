...
from sync_replicas_optimizer_modified.short_circuit_compute_gradient import *
...
class SyncReplicasOptimizerV2(optimizer.Optimizer):
  ...
  * `sync_rep_local_step`, one per replica. Compared against the global_step in
  ...
  def __init__(self,
    ...
    self._local_step = tf.identity(global_step)
  ...
  def apply_gradients(self, grads_and_vars, global_step=None, name=None):
    ...
    with ops.name_scope(None, self._name):
      ...
      return train_op, sync_token_queue.dequeue()
