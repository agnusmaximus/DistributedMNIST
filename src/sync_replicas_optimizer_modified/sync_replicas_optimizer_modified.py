  ...
  def apply_gradients(self, grads_and_vars, worker_id, global_step=None, name=None):
    ...
    with ops.name_scope(None, self._name):
      ...
      with ops.device(global_step.device), ops.name_scope(""):
        ...
        sync_ops = []
        with ops.control_dependencies([logging_ops.Print(global_step, [global_step], message="YO START TRAINING OPS")]):
          with ops.control_dependencies([train_op]):
            with ops.control_dependencies([logging_ops.Print(global_step, [global_step], message="YO FINISHED TRAINING OPS")]):
